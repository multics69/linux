...
#ifndef _LINUX_DEV_ENERGY_MODEL_GEN_H
#define _LINUX_DEV_ENERGY_MODEL_GEN_H
...
extern struct genl_family dev_energy_model_nl_family;

#endif /* _LINUX_DEV_ENERGY_MODEL_GEN_H */
